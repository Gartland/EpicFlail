	...
	void OnGUI(){
		...
		if(!dead && !weaponSheathed){
			...
			if(!blockGui && !isBlocking && !ledge){
				...
				if(warrior == Warrior.Sorceress || warrior == Warrior.Karate || warrior == Warrior.Spearman){
				...
				if(!blockGui && !isBlocking){
					...
					if(warrior == Warrior.Ninja || warrior == Warrior.Crossbow || warrior == Warrior.Karate || warrior == Warrior.Mage){
					...
					if(warrior == Warrior.Ninja || warrior == Warrior.Sorceress || warrior == Warrior.Karate || warrior == Warrior.Knight || warrior == Warrior.Mage){
